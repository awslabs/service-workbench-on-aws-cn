...
var RegisterAccountOperation = /*#__PURE__*/function (_Operation) {
  _inherits(RegisterAccountOperation, _Operation);

  var _super = _createSuper(RegisterAccountOperation);

  function RegisterAccountOperation(_ref) {
    var _this;
    ...
    _classCallCheck(this, RegisterAccountOperation);

    _this = _super.call(this);
    var id = account.id;
    _this.account = account;
    _this.name = "Registering account #".concat(id);
    _this.accountsStore = accountsStore;
    return _this;
  }

  _createClass(RegisterAccountOperation, [{
    key: "doRun",
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = this.account.id;
                this.setMessage("Registering AWS account #".concat(id));
                _context.prev = 2;
                _context.next = 5;
                return this.accountsStore.registerAccount(this.account);

              case 5:
                this.setMessage("Successfully registered account #".concat(id));
                _context.next = 14;
                break;
...
(0, _mobx.decorate)(RegisterAccountOperation, {
  doRun: _mobx.action
});
var _default = RegisterAccountOperation;
