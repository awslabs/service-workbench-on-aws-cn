...
exports.getCreateAwsAccountFormFields = getCreateAwsAccountFormFields;
exports.getCreateAwsAccountForm = getCreateAwsAccountForm;
 ...
 */
var createAwsAccountFormFields = {
  accountName: {
    label: 'Account Name',
...
function getCreateAwsAccountForm() {
  return (0, _form.createForm)(createAwsAccountFormFields);
}
//# sourceMappingURL=CreateAwsAccountForm.js.map