...
var _CreateAwsAccountForm = require("../../models/forms/CreateAwsAccountForm");
...
var CreateAwsAccount = /*#__PURE__*/function (_React$Component) {
  _inherits(CreateAwsAccount, _React$Component);

  var _super = _createSuper(CreateAwsAccount);

  function CreateAwsAccount(props) {
    var _this;

    _classCallCheck(this, CreateAwsAccount);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return (0, _Validate["default"])(_this.awsAccount, _this.createAwsAccountFormFields);
            ...
            case 9:
              _context.next = 11;
              return _this.props.awsAccountsStore.createAwsAccount(_this.awsAccount);
    ...
    _this.form = (0, _CreateAwsAccountForm.getCreateAwsAccountForm)();
    _this.createAwsAccountFormFields = (0, _CreateAwsAccountForm.getCreateAwsAccountFormFields)();
    return _this;
  }

  _createClass(CreateAwsAccount, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "mt3",
        color: "grey"
      }, "Create AWS Account"), /*#__PURE__*/_react["default"].createElement("div", {
        className: "mt3 ml3 mr3 animated fadeIn"
      }, this.renderCreateAwsAccountForm()));
    } // eslint-disable-next-line react/no-unused-state

  }, {
    key: "renderCreateAwsAccountForm",
    value: function renderCreateAwsAccountForm() {
      var _this2 = this;

      var processing = this.formProcessing;
      var fields = this.createAwsAccountFormFields;
...
(0, _mobx.decorate)(CreateAwsAccount, {
  formProcessing: _mobx.observable,
  user: _mobx.observable,
  validationErrors: _mobx.observable
});

var _default = (0, _mobxReact.inject)('usersStore', 'awsAccountsStore')((0, _reactRouterDom.withRouter)((0, _mobxReact.observer)(CreateAwsAccount)));

exports["default"] = _default;
//# sourceMappingURL=CreateAwsAccount.js.map