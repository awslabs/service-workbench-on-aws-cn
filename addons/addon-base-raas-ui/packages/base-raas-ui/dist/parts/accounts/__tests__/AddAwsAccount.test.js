...
var _AddAwsAccount = _interopRequireDefault(require("../AddAwsAccount"));
...
describe('AddAwsAccount', function () {
  ...
  beforeEach(function () {
    ...
    wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_AddAwsAccount["default"].WrappedComponent, {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            expect(awsAccountsStore.addAwsAccount).toHaveBeenCalledWith(component.awsAccount); // And user gets redirected to the accounts page
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            expect(awsAccountsStore.addAwsAccount).not.toHaveBeenCalled(); // Verify errors are set

            expect(component.validationErrors.errors).toBeDefined();
            fieldsWithError = Object.keys(component.validationErrors.errors);
            expect(fieldsWithError).toEqual(expect.arrayContaining(['name', 'accountId', 'roleArn', 'externalId', 'description', 'vpcId', 'subnetId', 'encryptionKeyArn']));
...
//# sourceMappingURL=AddAwsAccount.test.js.map