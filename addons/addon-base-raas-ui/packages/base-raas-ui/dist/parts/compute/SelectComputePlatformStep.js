...
var SelectComputePlatformStep = /*#__PURE__*/function (_React$Component) {
  _inherits(SelectComputePlatformStep, _React$Component);

  var _super = _createSuper(SelectComputePlatformStep);

  function SelectComputePlatformStep(props) {
    var _this;

    _classCallCheck(this, SelectComputePlatformStep);

    _this = _super.call(this, props);

    _this.handleSelectedComputeType = function (typeId) {
      _this.selectedPlatformId = typeId;
    };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return _this.props.onNext(_this.selectedPlatformId);
  ...
  _createClass(SelectComputePlatformStep, [{
    ...
    value: function renderContent() {
      ...
      var nextDisabled = _lodash["default"].isUndefined(this.selectedPlatformId);
    ...
    value: function renderCards() {
      ...
      var computeTypes = this.computePlatformsStore.list || [];

      var isSelected = function isSelected(type) {
        return type.id === _this2.selectedPlatformId;
      };
      ...
      var getAttrs = function getAttrs(type) {
        ...
        if (!processing) attrs.onClick = function () {
          return _this2.handleSelectedComputeType(type.id);
        };
        return attrs;
      };
      ...
      return /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Card.Group, {
        stackable: true,
        itemsPerRow: 3
      }, _lodash["default"].map(computeTypes, function (type) {
        ...
        }, getAttrs(type)), /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Card.Content, null, /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Card.Header, null, /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Radio, {
          className: "mr2",
          checked: isSelected(type),
          disabled: processing
        }), type.title, /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Divider, null)), /*#__PURE__*/_react["default"].createElement(_semanticUiReact.Card.Description, null, /*#__PURE__*/_react["default"].createElement("div", {
  ...
  return SelectComputePlatformStep;
}(_react["default"].Component); // see https://medium.com/@mweststrate/mobx-4-better-simpler-faster-smaller-c1fbc08008da


(0, _mobx.decorate)(SelectComputePlatformStep, {
  handlePrevious: _mobx.action,
  handleNext: _mobx.action,
  handleSelectedComputeType: _mobx.action,
...
var _default = (0, _mobxReact.inject)('userStore', 'computePlatformsStore')((0, _reactRouterDom.withRouter)((0, _mobxReact.observer)(SelectComputePlatformStep)));

exports["default"] = _default;
//# sourceMappingURL=SelectComputePlatformStep.js.map