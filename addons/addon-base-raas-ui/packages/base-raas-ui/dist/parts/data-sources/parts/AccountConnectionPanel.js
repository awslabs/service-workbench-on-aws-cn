...
var _AccountStatusMessage = _interopRequireDefault(require("./AccountStatusMessage"));
...
// - account (via props)
// - operation (via props)
var AccountConnectionPanel = /*#__PURE__*/function (_React$Component) {
  _inherits(AccountConnectionPanel, _React$Component);

  var _super = _createSuper(AccountConnectionPanel);

  function AccountConnectionPanel() {
    var _this;

    _classCallCheck(this, AccountConnectionPanel);
  ...
  _createClass(AccountConnectionPanel, [{
    key: "render",
    ...
    value: function renderMessage() {
      ...
      if (processing) return null;
      if (operation.hasError) return null;
      return /*#__PURE__*/_react["default"].createElement(_AccountStatusMessage["default"], {
        account: account,
        onCancel: this.handleCancel
      });
    }
  ...
  return AccountConnectionPanel;
}(_react["default"].Component); // see https://medium.com/@mweststrate/mobx-4-better-simpler-faster-smaller-c1fbc08008da


(0, _mobx.decorate)(AccountConnectionPanel, {
...
var _default = (0, _mobxReact.inject)()((0, _reactRouterDom.withRouter)((0, _mobxReact.observer)(AccountConnectionPanel)));

exports["default"] = _default;
//# sourceMappingURL=AccountConnectionPanel.js.map