...
var _rstudioIcon = _interopRequireDefault(require("../../../images/marketplace/rstudio-icon.svg"));
...
var EnvironmentCard = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(EnvironmentCard, [{
    ...
    value: function renderLeftCard(env) {
      ...
      }, status === 'COMPLETED' && (instanceInfo.type === 'ec2-rstudio' || instanceInfo.type === 'sagemaker' || instanceInfo.type === 'emr') && /*#__PURE__*/_react["default"].createElement(_EnvironmentConnectButton["default"], {
    ...
    value: function renderRightCard(environment) {
      var userDisplayName = this.getUserDisplayName();
      var sharedWithUsers = environment.sharedWithUsers; // array of uid

      var sharedWithUsernames = _lodash["default"].map(sharedWithUsers, function (uid) {
        return userDisplayName.getDisplayName({
          uid: uid
        });
      });
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        clamp: 1
      }, userDisplayName.getLongDisplayName({
    ...
    value: function renderStopButton(environment) {
      ...
      var validEnvTypes = ['ec2-windows', 'ec2-linux', 'ec2-rstudio', 'sagemaker']; // Render button if Environment can be stopped AND prevent admins from attempting to terminate external envs
