...
describe('ProviderService', () => {
  ...
  beforeAll(async () => {
    ...
    container.register('keycloakUserAttributesMapperService', new UserAttributesMapperServiceMock());
    ...
    userAttributesMapperService = await container.find('keycloakUserAttributesMapperService');
