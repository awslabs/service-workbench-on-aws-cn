...
const WorkflowTemplatesStore = BaseStore.named('WorkflowTemplatesStore').props({
  ...
  return {
    async doLoad() {
      ...
      const templates = toTemplates(versions); // we try to preserve existing template versions data and merge the new data instead
  ...
  get list() {
    ...
    return _.reverse(_.sortBy(result, ['latest.createdAt', 'title'])); // return result;
  },
...
//# sourceMappingURL=WorkflowTemplatesStore.js.map