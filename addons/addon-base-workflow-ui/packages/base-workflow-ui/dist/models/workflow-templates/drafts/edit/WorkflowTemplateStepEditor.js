...
const WorkflowTemplateStepEditor = types.model('WorkflowTemplateStepEditor', {
  stepId: '',
  // The step Id for the workflow template step
  contentExpanded: false,
  configEdit: false,
  // If we are editing mode or not for the configuration section
  configOverrideEdit: false,
  // If we are editing mode or not for the configuration override section
  descEdit: false,
  // If we are editing mode or not for the description section
  propsEdit: false,
  // If we are editing mode or not for the props section
