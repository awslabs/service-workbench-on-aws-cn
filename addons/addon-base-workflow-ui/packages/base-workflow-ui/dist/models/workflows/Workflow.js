...
const WorkflowAssignment = types.model('WorkflowAssignment', {
  id: '',
  wf: '',
  rev: types.number,
  createdAt: '',
...
const WorkflowInstance = types.model('WorkflowInstance', {
  id: types.identifier,
  wfId: '',
  wfVer: types.number,
  ...
  get statusSummary() {
    ...
    return {
      ...
      stepsSummary: [stepSummary('done'), stepSummary('error'), stepSummary('in_progress'), stepSummary('skipped'), stepSummary('not_started')],
      msgSpread: spread
    };
  },
...
const WorkflowVersion = types.model('WorkflowVersion', {
  id: '',
  v: types.number,
