...
const WorkflowInstancesStore = BaseStore.named('WorkflowInstancesStore').props({
  workflowId: '',
  ...
  return {
    ...
    async triggerWorkflow({
      ...
      const result = await triggerWorkflow(self.workflowId, self.workflowVer, {
        input
      });
      self.runInAction(() => {
        const version = self.version;
...
//# sourceMappingURL=WorkflowInstancesStore.js.map