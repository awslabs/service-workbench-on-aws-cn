...
const WorkflowStore = BaseStore.named('WorkflowStore').props({
  workflowId: '',
  ...
  return {
    ...
    getInstancesStore: (workflowId, workflowVer) => {
      ...
      if (!entry) {
        ...
        self.instancesStores.set(encodedId, WorkflowInstancesStore.create({
          workflowId,
          workflowVer
        }));
    ...
    getInstanceStore: (workflowVer, instanceId) => {
      ...
      if (!entry) {
        ...
        self.instanceStores.set(encodedId, WorkflowInstanceStore.create({
          workflowId,
          workflowVer,
          instanceId
        }));
    ...
    getAssignmentsStore: () => {
      ...
      if (!entry) {
        ...
        self.assignmentsStore.set(workflowId, WorkflowAssignmentsStore.create({
          workflowId
        }));
