...
import { getWorkflowDrafts, createWorkflowDraft, updateWorkflowDraft, publishWorkflowDraft, deleteWorkflowDraft } from '../../../helpers/api';
import WorkflowDraft from './WorkflowDraft'; // ==================================================================
// WorkflowDraftsStore
// ==================================================================

const WorkflowDraftsStore = BaseStore.named('WorkflowDraftsStore').props({
  ...
  return {
    async doLoad() {
      const drafts = await getWorkflowDrafts(); // We try to preserve existing drafts data and merge the new data instead
...
//# sourceMappingURL=WorkflowDraftsStore.js.map