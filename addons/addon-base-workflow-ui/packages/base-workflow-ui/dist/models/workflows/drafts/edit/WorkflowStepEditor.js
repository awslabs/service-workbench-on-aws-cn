...
const WorkflowStepEditor = types.model('WorkflowStepEditor', {
  stepId: '',
  // The step id for the workflow step
  ...
  return {
    ...
    afterAttach() {
      ...
      self.configurationEditor = ConfigurationEditor.create({
        inputManifest: _.isUndefined(inputManifest) ? undefined : prepareInputManifest(inputManifest, {
          allowed,
          defaults
        }),
...
function prepareInputManifest(inputManifest, {
  allowed = [],
