...
class CreateWorkflowTemplateDraft extends React.Component {
  constructor(props) {
    ...
    this.handleSelectionChange = templateId => {
      ...
      if (!draftsStore.hasTemplate(template.id)) {
        options.push({
          ...
          content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Label, {
            ...
            horizontal: true,
            size: "mini"
          }, "Existing"), ' ', template.latest.title, " ", /*#__PURE__*/React.createElement("span", {
  ...
  renderMain() {
    ...
    }), isNew && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Input, {
      field: templateIdField,
      disabled: processing
    }), /*#__PURE__*/React.createElement(Input, {
      field: templateTitleField,
      disabled: processing
...
export default inject('workflowTemplateDraftsStore', 'workflowTemplatesStore')(withRouter(observer(CreateWorkflowTemplateDraft)));
//# sourceMappingURL=CreateWorkflowTemplateDraft.js.map