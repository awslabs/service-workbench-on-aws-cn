...
class WorkflowTemplateDraftMetaEditor extends React.Component {
  constructor(props) {
    ...
    this.handleFormSubmission = async form => {
      ...
      template.setPropsOverrideOption({
        allowed
      });
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Form, {
      ...
      name: "list alternate outline",
      className: "color-grey"
    }), "Properties Override")), /*#__PURE__*/React.createElement(Segment, {
      padded: true
...
//# sourceMappingURL=WorkflowTemplateDraftMetaEditor.js.map