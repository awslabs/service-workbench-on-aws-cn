...
class WorkflowPublishedTemplatesList extends React.Component {
  ...
  renderEmpty() {
    ...
    }), "No published workflow templates", /*#__PURE__*/React.createElement(Header.Subheader, null, "To create a workflow template, start by creating a draft and then publish the draft.")));
  }
  ...
  renderMain() {
    ...
    return /*#__PURE__*/React.createElement("div", null, list.map(template => /*#__PURE__*/React.createElement(Segment, {
      className: "p3 mb2",
      clearing: true,
      key: template.id
    }, /*#__PURE__*/React.createElement(WorkflowTemplateCard, {
      template: template
    }))));
  }
...
//# sourceMappingURL=WorkflowPublishedTemplatesList.js.map