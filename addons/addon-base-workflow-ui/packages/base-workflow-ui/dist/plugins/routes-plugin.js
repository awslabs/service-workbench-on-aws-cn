...
function registerRoutes(routesMap, {
  ...
  const routes = new Map([...routesMap, ['/workflow-templates/drafts/edit/:draftId', withAuth(WorkflowTemplateDraftEditor)], ['/workflow-templates', withAuth(WorkflowTemplatesList)], ['/workflows/drafts/edit/:draftId', withAuth(WorkflowDraftEditor)], ['/workflows/published/id/:workflowId/v/:version/instances/id/:instanceId', withAuth(WorkflowInstanceDetailPage)], ['/workflows/published/id/:workflowId/v/:version', withAuth(WorkflowDetailPage)], ['/workflows', withAuth(WorkflowsList)]]);
  return routes;
}
