...
module.exports = {
  ...
  mergeSettings: (
    ...
    // If a component is global (e.g. a Lambda@Edge function) and region is not included in disableLambdaEdgeRegions list,
    ...
    if (globalDeployment && !mergedSettingsObj.disableLambdaEdgeRegions.includes(mergedSettingsObj.awsRegion)) {
      mergedSettingsObj.additionalAwsRegion = mergedSettingsObj.awsRegion;
      mergedSettingsObj.awsRegion = 'us-east-1';
    }
    if (mergedSettingsObj.disableLambdaEdgeRegions.includes(mergedSettingsObj.awsRegion)) {
    ...
    if (
      mergedSettingsObj.awsRegion !== 'us-east-1' &&
      !mergedSettingsObj.disableLambdaEdgeRegions.includes(mergedSettingsObj.awsRegion)
    ) {
