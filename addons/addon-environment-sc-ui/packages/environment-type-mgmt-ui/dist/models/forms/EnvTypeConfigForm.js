...
exports.getEnvTypeConfigForm = getEnvTypeConfigForm;
...
function getEnvTypeConfigForm(envTypeConfig) {
  var fields = {
    id: {
      ...
      extra: {
        explain: 'Unique identifier for this Configuration. ' + 'It must be an alpha numeric string between 2 and 128 characters long may contain underscore (_) and/or dash (-).'
      },
      value: _lodash["default"].get(envTypeConfig, 'id', ''),
    ...
    name: {
      ...
      extra: {
        explain: 'Easily identifiable name for this Configuration. ' + 'It must be an alpha numeric string between 2 and 128 characters long may contain space, underscore (_) and/or dash (-).'
      },
      value: _lodash["default"].get(envTypeConfig, 'name', ''),
      rules: ['required', 'min:2', 'max:128', 'regex:/^[A-Za-z0-9-_ ]+$/']
    },
    desc: {
      label: 'Description',
      ...
      extra: {
        explain: 'Description for this Configuration. Markdown syntax is supported'
      },
      value: _lodash["default"].get(envTypeConfig, 'desc', ''),
    ...
    estimatedCostInfo: {
      ...
      value: _lodash["default"].get(envTypeConfig, 'estimatedCostInfo', ''),
    ...
    allowRoleIds: {
      ...
      value: _lodash["default"].get(envTypeConfig, 'allowRoleIds', [])
    },
    denyRoleIds: {
      ...
      value: _lodash["default"].get(envTypeConfig, 'denyRoleIds', [])
    },
    ...
    params: {
      ...
      value: JSON.stringify(_lodash["default"].get(envTypeConfig, 'params', []))
    },
    ...
    tags: {
      label: 'Resource Tags',
      value: JSON.stringify(_lodash["default"].get(envTypeConfig, 'tags', []))
    }
  };
  return (0, _form.createForm)(fields);
} // eslint-disable-next-line import/prefer-default-export
//# sourceMappingURL=EnvTypeConfigForm.js.map