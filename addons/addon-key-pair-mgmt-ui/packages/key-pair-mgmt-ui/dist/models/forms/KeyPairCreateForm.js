...
function getKeyPairCreateForm() {
  const fields = {
    name: {
      ...
      extra: {
        explain: 'Easily identifiable name for this key. The name is used for display purposes.' + 'It must be an alpha numeric string between 2 and 100 characters long may contain space, underscore (_) and/or dash (-).'
      },
      value: '',
